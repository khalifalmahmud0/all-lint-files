...
if (
	...
	mix
		...
		// Frontend JS
		.js("src/js/frontend/frontend.js", "assets/js/frontend/")
	...
	// Frontend CSS
	if (!mix.inProduction()) {
		mix.sass("src/sass/frontend/frontend.scss", "assets/css/frontend/",).sourceMaps(true, 'source-map');
	} else {
		mix.sass("src/sass/frontend/frontend.scss", "assets/css/frontend/");
	}
}
